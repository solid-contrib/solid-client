...
var Permissions = {
  ...
  setPermissions: function setPermissions (url, agents, permissions,
    ...
    return Promise.resolve().then(function () {
      if (replaceExisting) {
        ...
        return mergeAcls(url, agents, permissions)
  ...
  getPermissions: function getPermissions (url) {
    ...
    return self.getDedicatedAclResource(url)
  ...
  isPermissionsInherited: function isPermissionsInherited (url) {
    return this.getDedicatedAclResource(url)
  },
...
function createAclResource (url, permissions) {
  ...
  // existing one
  return Permissions.getDedicatedAclResource(url)
