...
var Permissions = {
   ...
   * @param agents {Array<String>} List of agent WebIDs to set the permissions for
  ...
  setPermissions: function setPermissions (url, agents, permissions) {
    return new Promise(function (resolve, reject) {
      // reading the existing acls from the server and merging them with the
      // new acls for each agent
      mergeAcls(url, agents, permissions).then(
        function (mergedPermissions) {
          // having the merged permissions, create the RDF string representing
