 ...
 * {
 *   listed: [ array of triples (solid:instance or solid:instanceContainer) ],
 *   unlisted: [ array of triples (same) ]
 * }
 * ```
...
SolidProfile.prototype.typeRegistryForClass =
  function typeRegistryForClass (rdfClass) {
    return {
      listed: this.typeIndexListed.graph
        .statementsMatching(null, null, rdfClass),
      unlisted: this.typeIndexUnlisted.graph
        .statementsMatching(null, null, rdfClass)
    }
  }
