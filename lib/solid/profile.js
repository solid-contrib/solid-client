...
SolidProfile.prototype.registerType =
  function (rdfClass, location, locationType, accessLevel) {
 ...
 * @return {Promise<SolidProfile>}
 */
SolidProfile.prototype.unregisterType = function (rdfClass, accessLevel, location) {
  return typeRegistry.unregisterType(this, rdfClass, accessLevel, location)
}
