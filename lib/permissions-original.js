...
function Agent (webId, isSingular) {
  this.uri = webId
...
// Authorization object encapsulates Agent + Permissions + Resource + isDefault
...
Authorization.prototype.hash = function () {
  return hash.unique(this.agent.uri + '-' + this.isDefaultForNew)
}
