...
SolidProfile.prototype.initFromGraph = function initFromGraph (parsedProfile) {
  ...
  this.relatedProfiles.sameAs = parseLinks(parsedProfile, null,
    rdf.sym(Vocab.OWL.sameAs))
  this.relatedProfiles.seeAlso = parseLinks(parsedProfile, null,
    rdf.sym(Vocab.RDFS.seeAlso))

  // Init preferencesFile links
  this.relatedProfiles.preferences = parseLinks(parsedProfile, webId,
