...
"use strict";function addToTypeIndex(e,r,t,i,n){var s,o=require("shorthash"),d=o.unique(r.uri);if(s="listed"===n?e.typeIndexListed.uri:e.typeIndexUnlisted.uri,!s)throw new Error("Cannot register type, registry URL missing");var a,l=rdf.sym(s+"#"+d);a="instance"===i?vocab.solid("instance"):vocab.solid("instanceContainer");var u=null,p=[rdf.st(l,vocab.rdf("type"),vocab.solid("TypeRegistration")).toNT(),rdf.st(l,vocab.solid("forClass"),r).toNT(),rdf.st(l,a,rdf.sym(t)).toNT()];return webClient.patch(s,u,p).then(function(r){return e.loadTypeRegistry()})}function isUnlistedTypeIndex(e){return e.any(null,null,vocab.solid("UnlistedDocument"),e.uri)}function isListedTypeIndex(e){return e.any(null,null,vocab.solid("ListedDocument"),e.uri)}function loadTypeRegistry(e,r){r=r||{},r.headers=r.headers||{},r.headers.Accept||(r.headers.Accept="text/turtle");var t=[];return e.typeIndexListed.uri&&t.push(e.typeIndexListed.uri),e.typeIndexUnlisted.uri&&t.push(e.typeIndexUnlisted.uri),webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&e.addTypeRegistry(r.value,r.uri)}),e})}function registerType(e,r,t,i,n){if(!e)throw new Error("No profile provided");if(!e.isLoaded)throw new Error("Profile is not loaded");if(!r||!t)throw new Error("Type registration requires type class and location");if(n=n||"unlisted","listed"!==n&&"unlisted"!==n)throw new Error("Invalid index access level type");if(i=i||"container","container"!==i&&"instance"!==i)throw new Error("Invalid location type");return loadTypeRegistry(e).then(function(e){if("listed"===n&&!e.typeIndexListed.graph)throw new Error("Profile has no Listed type index");if("unlisted"===n&&!e.typeIndexUnlisted.graph)throw new Error("Profile has no Unlisted type index");return addToTypeIndex(e,r,t,i,n)})}function typeRegistryForClass(e,r){var t=[];return t.concat(registrationsFromGraph(e.typeIndexListed.graph,r,"listed")).concat(registrationsFromGraph(e.typeIndexUnlisted.graph,r,"unlisted"))}function registrationsFromGraph(e,r,t){var i,n,s=[];if(!e)return s;var o=e.statementsMatching(null,null,r);return o.forEach(function(o){i=o.subject,n=e.any(i,vocab.solid("instance")),n&&s.push(new IndexRegistration(i.uri,r,"instance",n.uri,t)),n=e.any(i,vocab.solid("instanceContainer")),n&&s.push(new IndexRegistration(i.uri,r,"container",n.uri,t))}),s}module.exports.loadTypeRegistry=loadTypeRegistry,module.exports.isUnlistedTypeIndex=isUnlistedTypeIndex,module.exports.isListedTypeIndex=isListedTypeIndex,module.exports.registerType=registerType,module.exports.typeRegistryForClass=typeRegistryForClass;var IndexRegistration=require("./solid/index-registration"),rdf=require("./util/rdf-parser").rdflib,webClient=require("./web"),vocab=require("./vocab");
