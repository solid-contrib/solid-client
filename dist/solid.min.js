...
"use strict";function appendGraph(e,t,r){var n=r?$rdf.sym(r):void 0;t.statementsMatching(void 0,void 0,void 0,n).forEach(function(t){e.add(t.subject,t.predicate,t.object,t.why)})}function extractWebId(e,t){return t.any($rdf.sym(e),FOAF("primaryTopic"))}function extractProfileResources(e,t,r){var n=[],i=[OWL("sameAs"),RDFS("seeAlso"),PIM("preferencesFile")];return i.forEach(function(i){var o=r.statementsMatching(e,i,void 0,$rdf.sym(t));o.length>0&&(n=n.concat(o))}),n}function loadGraphs(e,t,r){var n=!0,i=e.map(function(e){return solidClient.getParsedGraph(e.object.uri,t,r,n).then(function(t){return{uri:e.object.uri,value:t}})});return Promise.all(i)}function getProfile(e,t){var r=require("../config"),n=r.proxyUrl,i=r.timeout;return solidClient.getParsedGraph(e).then(function(r){if(t)return r;var o=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e,a=extractWebId(o,r),c=extractProfileResources(a,o,r);return 0===c.length?r:loadGraphs(c,n,i).then(function(e){return e.forEach(function(e){e&&appendGraph(r,e.value,e.uri)}),r})})}function getWorkspaces(e,t){var r=new Promise(function(r,n){if(t){var i=[],o=t.statementsMatching($rdf.sym(e),PIM("workspace"),void 0);return 0===o.length?r(i):(o.forEach(function(e){var r={},n=t.any(e.object,DCT("title"));n&&n.value&&(r.title=n.value),r.url=e.object.uri,r.statements=t.statementsMatching(e.object,void 0,void 0),i.push(r)}),r(i))}getProfile(e).then(function(t){getWorkspaces(e,t).then(function(e){return r(e)})["catch"](function(e){return n(e)})})["catch"](function(e){return n(e)})});return r}function getWritableProfiles(e,t){var r=new Promise(function(r,n){if(t){var i=[];e=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e;var o=t.any($rdf.sym(e),FOAF("primaryTopic")),a=[];a=a.concat(t.statementsMatching(o,OWL("sameAs"),void 0,$rdf.sym(e))),a=a.concat(t.statementsMatching(o,RDFS("seeAlso"),void 0,$rdf.sym(e))),a=a.concat(t.statementsMatching(o,PIM("preferencesFile"),void 0,$rdf.sym(e))),a=a.concat({object:{uri:e}});var c=a.length,s=function(){return 0===c?r(i):void 0};if(0===c)return r(i);a.forEach(function(e){var t=e.object.uri;solidClient.head(t).then(function(e){e.editable.length>0&&i.indexOf(t)<0&&i.push({url:t,editable:e.editable}),c--,s()})["catch"](function(e){if(e)throw e;c--,s()})})}else getProfile(e).then(function(t){getWritableProfiles(e,t).then(function(e){return r(e)})["catch"](function(e){return n(e)})})["catch"](function(e){return n(e)})});return r}var solidClient=require("./web"),RDFS=$rdf.Namespace("http://www.w3.org/2000/01/rdf-schema#"),OWL=$rdf.Namespace("http://www.w3.org/2002/07/owl#"),PIM=$rdf.Namespace("http://www.w3.org/ns/pim/space#"),FOAF=$rdf.Namespace("http://xmlns.com/foaf/0.1/"),DCT=$rdf.Namespace("http://purl.org/dc/terms/");module.exports.getProfile=getProfile,module.exports.getWorkspaces=getWorkspaces,module.exports.getWritableProfiles=getWritableProfiles,module.exports.extractProfileResources=extractProfileResources;
