...
"use strict";function getProfile(e,r,t,o){var i=require("../config");t=t||i.proxyUrl,o=o||i.timeout;var l={headers:{Accept:"text/turtle"},proxyUrl:t,timeout:o};return webClient.get(e,l).then(function(t){var o=t.contentType();if(!o)throw new Error("Cannot parse profile without a Content-Type: header");var i=graphUtil.parseGraph(e,t.raw(),o),a=new SolidProfile(e,i,t);return r?a:loadExtendedProfile(a,l)})}function loadExtendedProfile(e,r){r=r||{},r.headers=r.headers||{Accept:"text/turtle"};var t=e.relatedProfilesLinks();return webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&graphUtil.appendGraph(e.parsedGraph,r.value,r.uri)}),e})}module.exports.getProfile=getProfile,module.exports.loadExtendedProfile=loadExtendedProfile;var graphUtil=require("./graph-util"),webClient=require("./web"),SolidProfile=require("./solid-profile");
...
"use strict";var RDFParser={};"undefined"!=typeof window?RDFParser.rdflib=window.$rdf:RDFParser.rdflib=require("rdflib"),module.exports=RDFParser;
},{"rdflib":undefined}],7:[function(require,module,exports){
"use strict";function SolidProfile(e,r,s){this.externalResources={inbox:null,preferences:[],storage:[],publicTypeIndexes:[],privateTypeIndexes:[]},this.parsedGraph=r,this.response=s,this.relatedProfiles={sameAs:[],seeAlso:[]},this.webId=null,e&&(this.baseProfileUrl=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e,r&&this.initFromGraph(r))}function extractWebId(e,r){var s=rdf.sym(e),i=rdf.sym(Vocab.FOAF.primaryTopic),t=r.any(s,i);return t}function parseLink(e,r,s,i,t){var o=e.any(r,s,i,t);return o?o.uri:null}function parseLinks(e,r,s,i,t){var o=[],n=e.statementsMatching(r,s,i,t);return n.forEach(function(e){o.push(e.object.uri)}),o}module.exports=SolidProfile;var rdf=require("./rdf-parser").rdflib,Vocab=require("./vocab");SolidProfile.prototype.initFromGraph=function(e){if(e){try{this.webId=extractWebId(this.baseProfileUrl,e).uri}catch(r){throw new Error("Unable to parse WebID from profile")}var s=rdf.sym(this.webId);this.relatedProfiles.sameAs=parseLinks(e,s,rdf.sym(Vocab.OWL.sameAs)),this.relatedProfiles.seeAlso=parseLinks(e,s,rdf.sym(Vocab.RDFS.seeAlso)),this.externalResources.preferences=parseLinks(e,s,rdf.sym(Vocab.PIM.preferencesFile)),this.externalResources.inbox=parseLink(e,s,rdf.sym(Vocab.SOLID.inbox)),this.externalResources.storage=parseLinks(e,s,rdf.sym(Vocab.PIM.storage)),this.externalResources.publicTypeIndexes=parseLinks(e,s,rdf.sym(Vocab.SOLID.publicTypeIndex)),this.externalResources.privateTypeIndexes=parseLinks(e,s,rdf.sym(Vocab.SOLID.privateTypeIndex))}},SolidProfile.prototype.relatedProfilesLinks=function(){return this.relatedProfiles.sameAs.concat(this.relatedProfiles.seeAlso)},SolidProfile.prototype.inbox=function(){return this.externalResources.inbox},SolidProfile.prototype.preferences=function(){return this.externalResources.preferences},SolidProfile.prototype.storage=function(){return this.externalResources.storage},SolidProfile.prototype.publicTypeIndexes=function(){return this.externalResources.publicTypeIndexes},SolidProfile.prototype.privateTypeIndexes=function(){return this.externalResources.privateTypeIndexes};
...
"use strict";var XMLHttpRequest;XMLHttpRequest="undefined"!=typeof window&&"XMLHttpRequest"in window?window.XMLHttpRequest:require("xhr2"),module.exports=XMLHttpRequest;
