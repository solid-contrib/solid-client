...
"use strict";function getProfile(e,r,t,i){var l=require("../config");t=t||l.proxyUrl,i=i||l.timeout;var o={headers:{Accept:"text/turtle"},proxyUrl:t,timeout:i};return webClient.get(e,o).then(function(r){var t=r.contentType();return t||(t="text/turtle"),graphUtil.parseGraph(e,r.raw(),t)}).then(function(t){var i=new SolidProfile(e,t);return r?i:loadExtendedProfile(i,o)})}function loadExtendedProfile(e,r){r=r||{},r.headers=r.headers||{Accept:"text/turtle"};var t=e.relatedProfilesLinks();return webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&graphUtil.appendGraph(e.parsedGraph,r.value,r.uri)}),e})}module.exports.getProfile=getProfile,module.exports.loadExtendedProfile=loadExtendedProfile;var graphUtil=require("./graph-util"),webClient=require("./web"),SolidProfile=require("./solid-profile");
...
"use strict";function SolidProfile(e,r){this.externalResources={inbox:null,preferences:[],storage:[]},this.parsedGraph=r,this.relatedProfiles={sameAs:[],seeAlso:[]},this.webId=null,e&&(this.baseProfileUrl=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e,r&&this.initFromGraph(r))}function extractWebId(e,r){var s=rdf.sym(e),i=rdf.sym(Vocab.FOAF.primaryTopic),o=r.any(s,i);return o}function parseLink(e,r,s,i,o){var t=e.any(r,s,i,o);return t?t.uri:null}function parseLinks(e,r,s,i,o){var t=[],n=e.statementsMatching(r,s,i,o);return n.forEach(function(e){t.push(e.object.uri)}),t}module.exports=SolidProfile;var rdf=require("./rdf-parser").rdflib,Vocab=require("./vocab");SolidProfile.prototype.initFromGraph=function(e){if(e){try{this.webId=extractWebId(this.baseProfileUrl,e).uri}catch(r){throw new Error("Unable to parse WebID from profile")}var s=rdf.sym(this.webId);this.relatedProfiles.sameAs=parseLinks(e,s,rdf.sym(Vocab.OWL.sameAs)),this.relatedProfiles.seeAlso=parseLinks(e,s,rdf.sym(Vocab.RDFS.seeAlso)),this.externalResources.preferences=parseLinks(e,s,rdf.sym(Vocab.PIM.preferencesFile)),this.externalResources.inbox=parseLink(e,s,rdf.sym(Vocab.SOLID.inbox)),this.externalResources.storage=parseLinks(e,s,rdf.sym(Vocab.PIM.storage))}},SolidProfile.prototype.relatedProfilesLinks=function(){return this.relatedProfiles.sameAs.concat(this.relatedProfiles.seeAlso)},SolidProfile.prototype.inbox=function(){return this.externalResources.inbox},SolidProfile.prototype.preferences=function(){return this.externalResources.preferences},SolidProfile.prototype.storage=function(){return this.externalResources.storage};
