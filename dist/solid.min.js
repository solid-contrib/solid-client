...
"use strict";function SolidContainer(r,e){SolidResource.call(this,r,e),this.containers={},this.contentsUris=[],this.resources={},e&&this.initFromResponse(this.uri,e)}module.exports=SolidContainer;var rdf=require("../util/rdf-parser").rdflib,graphUtil=require("../util/graph-util"),parseLinks=graphUtil.parseLinks,Vocab=require("../vocab"),SolidResource=require("./resource");SolidContainer.prototype=Object.create(SolidResource.prototype),SolidContainer.prototype.constructor=SolidContainer,SolidContainer.prototype.appendFromGraph=function(r,e){var i=parseLinks(r,null,rdf.sym(Vocab.LDP.contains));this.contentsUris=this.contentsUris.concat(i.sort());var o,t=r.each(null,null,rdf.sym(Vocab.LDP.Container)),n=this;t.forEach(function(e){e.uri!==n.uri&&(o=new SolidContainer(e.uri),o.types=Object.keys(r.findTypeURIs(e)),n.containers[o.uri]=o)});var s,a,c;i.forEach(function(e){a=e in n.containers,s=e!==n.uri&&!a,s&&(c=new SolidResource(e),c.types=Object.keys(r.findTypeURIs(rdf.sym(e))),n.resources[e]=c)})},SolidContainer.prototype.initFromResponse=function(r,e){var i=e.contentType();if(!i)throw new Error("Cannot parse container without a Content-Type: header");var o=graphUtil.parseGraph(r,e.raw(),i);this.parsedGraph=o,this.appendFromGraph(o,r)};
...
"use strict";function SolidResource(i,t){this.name=null,this.parsedGraph=null,this.response=t,this.types=[],this.uri=i,t&&t.url!==i&&(this.uri=t.url),this.initName()}module.exports=SolidResource,SolidResource.prototype.initName=function(){if(this.uri){var i=this.uri.split("/");this.name=i.pop(),!this.name&&i.length>0&&(this.name=i.pop())}};
...
"use strict";function appendGraph(r,e,a){var p=a?rdf.sym(a):void 0;e.statementsMatching(void 0,void 0,void 0,p).forEach(function(e){r.add(e.subject,e.predicate,e.object,e.why)})}function parseGraph(r,e,a){var p=rdf.graph();return rdf.parse(e,p,r,a),p}function parseLinks(r,e,a,p,t){var s=[],n=r.statementsMatching(e,a,p,t);return n.forEach(function(r){s.push(r.object.uri)}),s}module.exports.appendGraph=appendGraph,module.exports.parseGraph=parseGraph,module.exports.parseLinks=parseLinks;var rdf=require("./rdf-parser").rdflib;
