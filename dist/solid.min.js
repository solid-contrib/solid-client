...
"use strict";function parseResponseMeta(e){var t=parseLinkHeader(e.getResponseHeader("Link")),s={};s.url=e.getResponseHeader("Location")?e.getResponseHeader("Location"):e.responseURL,s.acl=t.acl,s.meta=t.meta?t.meta:t.describedBy,s.user=e.getResponseHeader("User")?e.getResponseHeader("User"):"",s.websocket=e.getResponseHeader("Updates-Via")?e.getResponseHeader("Updates-Via"):"",s.editable=[];var r=e.getResponseHeader("Accept-Patch");r&&r.indexOf("application/sparql-update")>=0&&s.editable.push("patch");var n=e.getResponseHeader("Allow");return n&&(n.indexOf("PUT")>=0&&s.editable.push("put"),n.indexOf("POST")>=0&&s.editable.push("post"),n.indexOf("DELETE")>=0&&s.editable.push("delete")),s.exists=200===e.status,s.xhr=e,s}var XMLHttpRequest=require("./xhr.js"),PROXY="https://databox.me/,proxy?uri={uri}",TIMEOUT=5e3;$rdf.Fetcher.crossSiteProxyTemplate=PROXY;var LDP=$rdf.Namespace("http://www.w3.org/ns/ldp#"),parseLinkHeader=function(e){for(var t=/<[^>]*>\s*(\s*;\s*[^\(\)<>@,;:"\/\[\]\?={} \t]+=(([^\(\)<>@,;:"\/\[\]\?={} \t]+)|("[^"]*")))*(,|$)/g,s=/[^\(\)<>@,;:"\/\[\]\?={} \t]+=(([^\(\)<>@,;:"\/\[\]\?={} \t]+)|("[^"]*"))/g,r=e.match(t),n={},i=0;i<r.length;i++)for(var a=r[i].split(">"),o=a[0].substring(1),u=a[1],d=u.match(s),l=0;l<d.length;l++){var p=d[l],h=p.split("="),c=h[1].replace(/["']/g,"");n[c]=o}return n},SolidWebClient={solidRequest:function(e,t,s,r,n){return new Promise(function(r,i){n=n||{};var a=new XMLHttpRequest;a.open(t,e),a.withCredentials=!0,s&&a.setRequestHeader("Content-Type",s);for(var o in n)a.setRequestHeader(o,n[o]);a.onload=function(){this.status>=200&&this.status<300?r(parseResponseMeta(this)):i({status:this.status,statusText:this.statusText,xhr:this})},a.onerror=function(){i({status:this.status,statusText:this.statusText,xhr:this})},a.send()})},head:function(e){return this.solidRequest(e,"HEAD")},get:function(e){var t=new Promise(function(t,s){var r=$rdf.graph(),n=new $rdf.Fetcher(r,TIMEOUT),i=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e;n.nowOrWhenFetched(i,void 0,function(e,n,i){e?t(r):s({status:i.status,xhr:i})})});return t},post:function(e,t,s,r,n){var i;r?(i=LDP("BasicContainer").uri,n="text/turtle"):(i=LDP("Resource").uri,n=n||"text/turtle");var a={};return a.Link="<"+i+'>; rel="type"',s&&s.length>0&&(a.Slug=s),this.solidRequest(e,"POST",n,t,a)},put:function(e,t,s){return this.solidRequest(e,"PUT",s,t)},patch:function(e,t,s){var r,n="";if(t&&t.length>0)for(r=0;r<t.length;r++)r>0&&(n+=" ;\n"),n+="DELETE DATA { "+t[r]+" }";if(s&&s.length>0)for(r=0;r<s.length;r++)(r>0||t&&t.length>0)&&(n+=" ;\n"),n+="INSERT DATA { "+s[r]+" }";var i="application/sparql-update";return this.solidRequest(e,"PATCH",i,n)},del:function(e){return this.solidRequest(e,"DELETE")}};SolidWebClient.create=SolidWebClient.post,SolidWebClient.replace=SolidWebClient.put,SolidWebClient.update=SolidWebClient.patch,SolidWebClient.parseLinkHeader=parseLinkHeader,module.exports=SolidWebClient;
