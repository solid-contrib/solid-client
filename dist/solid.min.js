...
"use strict";function getProfile(e,r,t,i){var n=require("../config");t=t||n.proxyUrl,i=i||n.timeout;var o={headers:{Accept:"text/turtle"},proxyUrl:t,timeout:i};return webClient.get(e,o).then(function(t){var i=t.contentType();if(!i)throw new Error("Cannot parse profile without a Content-Type: header");var n=graphUtil.parseGraph(e,t.raw(),i),a=new SolidProfile(e,n,t);return r?a:loadExtendedProfile(a,o)})}function loadExtendedProfile(e,r){r=r||{},r.headers=r.headers||{Accept:"text/turtle"};var t=e.relatedProfilesLinks();return webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&graphUtil.appendGraph(e.parsedGraph,r.value,r.uri)}),e}).then(function(e){return loadTypeRegistry(e,r)})}function loadTypeRegistry(e,r){r=r||{},r.headers=r.headers||{Accept:"text/turtle"};var t=e.typeIndexes();return webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&e.addTypeRegistry(r)}),e})}function isPrivateTypeIndex(e){var r=rdf.sym(Vocab.SOLID.PrivateTypeIndex);return e.any(null,null,r,e.uri)}function isPublicTypeIndex(e){var r=rdf.sym(Vocab.SOLID.PublicTypeIndex);return e.any(null,null,r,e.uri)}module.exports.getProfile=getProfile,module.exports.loadExtendedProfile=loadExtendedProfile,module.exports.loadTypeRegistry=loadTypeRegistry,module.exports.isPrivateTypeIndex=isPrivateTypeIndex,module.exports.isPublicTypeIndex=isPublicTypeIndex;var graphUtil=require("./graph-util"),webClient=require("./web"),SolidProfile=require("./solid-profile"),rdf=require("./rdf-parser").rdflib,Vocab=require("./vocab");
...
"use strict";function SolidProfile(e,r,t){this.externalResources={inbox:null,preferences:[],storage:[],typeIndexes:[]},this.typeIndexPublic=rdf.graph(),this.typeIndexPrivate=rdf.graph(),this.parsedGraph=r,this.response=t,this.relatedProfiles={sameAs:[],seeAlso:[]},this.webId=null,e&&(this.baseProfileUrl=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e,r&&this.initFromGraph(r))}function extractWebId(e,r){var t=rdf.sym(e),i=rdf.sym(Vocab.FOAF.primaryTopic),s=r.any(t,i);return s}function parseLink(e,r,t,i,s){var n=e.any(r,t,i,s);return n?n.uri:null}function parseLinks(e,r,t,i,s){var n=[],o=e.statementsMatching(r,t,i,s);return o.forEach(function(e){n.push(e.object.uri)}),n}module.exports=SolidProfile;var rdf=require("./rdf-parser").rdflib,Vocab=require("./vocab"),identity=require("./identity"),graphUtil=require("./graph-util");SolidProfile.prototype.initFromGraph=function(e){if(e){try{this.webId=extractWebId(this.baseProfileUrl,e).uri}catch(r){throw new Error("Unable to parse WebID from profile")}var t=rdf.sym(this.webId);this.relatedProfiles.sameAs=parseLinks(e,t,rdf.sym(Vocab.OWL.sameAs)),this.relatedProfiles.seeAlso=parseLinks(e,t,rdf.sym(Vocab.RDFS.seeAlso)),this.externalResources.preferences=parseLinks(e,t,rdf.sym(Vocab.PIM.preferencesFile)),this.externalResources.inbox=parseLink(e,t,rdf.sym(Vocab.SOLID.inbox)),this.externalResources.storage=parseLinks(e,t,rdf.sym(Vocab.PIM.storage)),this.externalResources.typeIndexes=parseLinks(e,t,rdf.sym(Vocab.SOLID.typeIndex))}},SolidProfile.prototype.relatedProfilesLinks=function(){return this.relatedProfiles.sameAs.concat(this.relatedProfiles.seeAlso)},SolidProfile.prototype.inbox=function(){return this.externalResources.inbox},SolidProfile.prototype.preferences=function(){return this.externalResources.preferences},SolidProfile.prototype.storage=function(){return this.externalResources.storage},SolidProfile.prototype.typeIndexes=function(){return this.externalResources.typeIndexes},SolidProfile.prototype.addTypeRegistry=function(e){if(identity.isPublicTypeIndex(e))graphUtil.appendGraph(this.typeIndexPublic,e,e.uri);else{if(!identity.isPrivateTypeIndex(e))throw new Error("Attempting to add an invalid type registry index");graphUtil.appendGraph(this.typeIndexPrivate,e,e.uri)}},SolidProfile.prototype.typeRegistryForClass=function(e){return{"public":this.typeIndexPublic.statementsMatching(null,null,e),"private":this.typeIndexPrivate.statementsMatching(null,null,e)}};
