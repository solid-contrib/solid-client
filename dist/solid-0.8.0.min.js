...
"use strict";function getProfile(e,r,t,o){var i=require("../config");t=t||i.proxyUrl,o=o||i.timeout;var n={headers:{Accept:"text/turtle"},proxyUrl:t,timeout:o};return webClient.get(e,n).then(function(r){var t=r.contentType();if(!t)throw new Error("Cannot parse profile without a Content-Type: header");return graphUtil.parseGraph(e,r.raw(),t)}).then(function(t){var o=new SolidProfile(e,t);return r?o:loadExtendedProfile(o,n)})}function loadExtendedProfile(e,r){r=r||{},r.headers=r.headers||{Accept:"text/turtle"};var t=e.relatedProfilesLinks();return webClient.loadParsedGraphs(t,r).then(function(r){return r.forEach(function(r){r&&r.value&&graphUtil.appendGraph(e.parsedGraph,r.value,r.uri)}),e})}module.exports.getProfile=getProfile,module.exports.loadExtendedProfile=loadExtendedProfile;var graphUtil=require("./graph-util"),webClient=require("./web"),SolidProfile=require("./solid-profile");
