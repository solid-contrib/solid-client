...
"use strict";function SolidProfile(e,i,r){this.inbox={uri:null,graph:null},this.isLoaded=!1,this.storage=[],this.typeIndexes=[],this.typeIndexPublic={uri:null,graph:null},this.typeIndexPrivate={uri:null,graph:null},this.parsedGraph=null,this.preferences={uri:null,graph:null},this.response=r,this.relatedProfiles={sameAs:[],seeAlso:[]},this.webId=null,e&&(this.baseProfileUrl=e.indexOf("#")>=0?e.slice(0,e.indexOf("#")):e,i&&(this.initWebId(i),this.appendFromGraph(i,this.baseProfileUrl)))}function extractWebId(e,i){var r=rdf.sym(e),t=vocab.foaf("primaryTopic"),s=i.any(r,t);return s}function parseLink(e,i,r,t,s){var n=e.any(i,r,t,s);return n?n.uri:null}module.exports=SolidProfile;var rdf=require("../util/rdf-parser").rdflib,vocab=require("../vocab"),identity=require("../identity"),graphUtil=require("../util/graph-util"),parseLinks=graphUtil.parseLinks;SolidProfile.prototype.appendFromGraph=function(e,i){if(e){this.parsedGraph=this.parsedGraph||rdf.graph(),graphUtil.appendGraph(this.parsedGraph,e,i);var r,t=rdf.sym(this.webId);r=parseLinks(e,null,vocab.owl("sameAs")),this.relatedProfiles.sameAs=this.relatedProfiles.sameAs.concat(r),r=parseLinks(e,null,vocab.rdfs("seeAlso")),this.relatedProfiles.seeAlso=this.relatedProfiles.seeAlso.concat(r),this.preferences.uri||(this.preferences.uri=parseLink(e,t,vocab.pim("preferencesFile"))),this.inbox.uri||(this.inbox.uri=parseLink(e,t,vocab.solid("inbox"))),r=parseLinks(e,t,vocab.pim("storage")),this.storage=this.storage.concat(r),r=parseLinks(e,t,vocab.solid("typeIndex")),this.typeIndexes=this.typeIndexes.concat(r)}},SolidProfile.prototype.initWebId=function(e){if(e)try{this.webId=extractWebId(this.baseProfileUrl,e).uri}catch(i){throw new Error("Unable to parse WebID from profile")}},SolidProfile.prototype.relatedProfilesLinks=function(){var e=[];return e=e.concat(this.relatedProfiles.sameAs).concat(this.relatedProfiles.seeAlso),this.preferences.uri&&(e=e.concat(this.preferences.uri)),e},SolidProfile.prototype.hasStorage=function(){return this.storage&&this.storage.length>0},SolidProfile.prototype.loadTypeRegistry=function(e){return identity.loadTypeRegistry(this,e)},SolidProfile.prototype.addTypeRegistry=function(e){if(identity.isPublicTypeIndex(e))this.typeIndexPublic.graph||(this.typeIndexPublic.uri=e.uri,this.typeIndexPublic.graph=e);else{if(!identity.isPrivateTypeIndex(e))throw new Error("Attempting to add an invalid type registry index");this.typeIndexPrivate.graph||(this.typeIndexPrivate.uri=e.uri,this.typeIndexPrivate.graph=e)}},SolidProfile.prototype.typeRegistryForClass=function(e){return{"public":this.typeIndexPublic.graph.statementsMatching(null,null,e),"private":this.typeIndexPrivate.graph.statementsMatching(null,null,e)}};
